...
class Program
{
    static void Main(string[] args)
    {
        ...
        library.AddBook(new Book("Panchatanthra", "Mary", "9781593275846"));
        library.AddBook(new Book("Variety", "Pooja", "9780061120084"));
        library.AddBook(new Book("RomeoJuliet", "ShakesSpear", "9780061120084"));
